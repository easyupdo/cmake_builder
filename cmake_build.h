...
public:
    ...
    static QString target_link_libraries(QString current_dir, QString lib_name,cmake_type type);
     static QString target_link_libraries(QString exec_name, QString lib_path_name);
    ...
    //template <class type>
    static QString SetTribleParameter(QString options, QString Parameter1, QString Parameter2, QString Parameter3);
    ...
    static QString FindLibrary(QString argv, QString lib_name, QString lib_path);
    ~cmake_build();
